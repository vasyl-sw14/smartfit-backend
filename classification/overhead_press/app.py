...
loaded_model = tf.keras.models.load_model("overhead_press.keras")

def handler(event, _):
    print(event)
    prefix = event["Records"][0]["body"]["responsePayload"]["prefix"]
    ...
    for file in result['Contents']:
        ...
        inference_results.append({"key": file['Key'].split("/")[2].split('.')[0], "classes": classes})
